    ...
    return (
        <div class="footer">
          ...
          <div class="col-sm-5 offset-sm-2  offset-md-4 col-md-4 offset-md-0 p-4 col-sm-8">
            ...
            <a href="#"><i class="fa-brands fa-facebook fs-5 mr-3"></i></a>
            <a href="#"><i class="fa-brands fa-square-instagram fs-5 mr-3"></i></a>
            <a href="#"><i class="fa-brands fa-square-youtube fs-5 mr-3"></i></a>
            <a href="#"><i class="fa-brands fa-square-twitter fs-5 mr-3"></i></a>
            </div>
